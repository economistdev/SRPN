...
# compile the java files in ./SRPN 
os.system("javac ./SRPN/*.java")
...
while place <= 5:
  ...
  os.system("java -cp ./SRPN Main < t-single/0" + str(place) + " > test.txt")
...
while place <= 5:
  ...
  os.system("java -cp ./SRPN Main < t-multiple/0" + str(place) + " > test.txt")
...
while place <= 5:
  ...
  os.system("java -cp ./SRPN Main < t-saturation/0" + str(place) + " > test.txt")
...
while place <= 5:
  ...
  os.system("java -cp ./SRPN Main < t-obscure/0" + str(place) + " > test.txt")
